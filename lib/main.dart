...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'iOS 14 Cupertino Icons'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Map<String, IconData> _activeIcons;
    ...
    _iconController.addListener(() {
      setState(() {
        ...
        if (_iconController.text.isNotEmpty) {
          _activeIcons
              .removeWhere((key, value) => !key.contains(_iconController.text));
        }
      });
    });
  }
            ...
            child: Scrollbar(
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  _iconData = _activeIcons.values.toList();
                  _iconName = _activeIcons.keys.toList();
                  return Center(
                    child: Padding(
